...
$(document).ready(function () {
	...
	$( "#date83" ).datepicker({format: 'yyyy-mm-dd', autoclose: true, todayHighlight: true});
	$( "#date85" ).datepicker({format: 'yyyy-mm-dd', autoclose: true, todayHighlight: true});
	$( "#date87" ).datepicker({format: 'yyyy-mm-dd', autoclose: true, todayHighlight: true});
	$( "#date89" ).datepicker({format: 'yyyy-mm-dd', autoclose: true, todayHighlight: true});	
	$( "#date91" ).datepicker({format: 'yyyy-mm-dd', autoclose: true, todayHighlight: true});
	$( "#date93" ).datepicker({format: 'yyyy-mm-dd', autoclose: true, todayHighlight: true});	
	$( "#date95" ).datepicker({format: 'yyyy-mm-dd', autoclose: true, todayHighlight: true});
	$( "#date97" ).datepicker({format: 'yyyy-mm-dd', autoclose: true, todayHighlight: true});
	$( "#date99" ).datepicker({format: 'yyyy-mm-dd', autoclose: true, todayHighlight: true});
	...
	$( "#dateDue" ).datepicker({
		...
		todayHighlight: true
			...
			$( "#date83" ).datepicker("setEndDate", newMaxDeadline);
			$( "#date85" ).datepicker("setEndDate", newMaxDeadline);
			$( "#date87" ).datepicker("setEndDate", newMaxDeadline);
			$( "#date89" ).datepicker("setEndDate", newMaxDeadline);
			$( "#date91" ).datepicker("setEndDate", newMaxDeadline);
			$( "#date93" ).datepicker("setEndDate", newMaxDeadline);
			$( "#date95" ).datepicker("setEndDate", newMaxDeadline);
			$( "#date97" ).datepicker("setEndDate", newMaxDeadline);
			$( "#date99" ).datepicker("setEndDate", newMaxDeadline);
		...
		$( "#date84" ).datepicker({format: 'yyyy-mm-dd', autoclose: true, todayHighlight: true, endDate: 'today'});		
		$( "#date86" ).datepicker({format: 'yyyy-mm-dd', autoclose: true, todayHighlight: true, endDate: 'today'});		
		$( "#date88" ).datepicker({format: 'yyyy-mm-dd', autoclose: true, todayHighlight: true, endDate: 'today'});
		$( "#date90" ).datepicker({format: 'yyyy-mm-dd', autoclose: true, todayHighlight: true, endDate: 'today'});			
		$( "#date92" ).datepicker({format: 'yyyy-mm-dd', autoclose: true, todayHighlight: true, endDate: 'today'});		
		$( "#date94" ).datepicker({format: 'yyyy-mm-dd', autoclose: true, todayHighlight: true, endDate: 'today'});		
		$( "#date96" ).datepicker({format: 'yyyy-mm-dd', autoclose: true, todayHighlight: true, endDate: 'today'});		
		$( "#date98" ).datepicker({format: 'yyyy-mm-dd', autoclose: true, todayHighlight: true, endDate: 'today'});		
		$( "#date100" ).datepicker({format: 'yyyy-mm-dd', autoclose: true, todayHighlight: true, endDate: 'today'});			

		...
		query.count({
			success: function(results){
				if(results == 0) {
					...
					data.status45 = document.getElementById("status45").checked;
					data.status46 = document.getElementById("status46").checked;
					data.status47 = document.getElementById("status47").checked;
					data.status48 = document.getElementById("status48").checked;
					data.status49 = document.getElementById("status49").checked;
					data.status50 = document.getElementById("status50").checked;
					*/
